/home/workspace2/base/hypervisor/fvp/Base_RevC_AEMvA_pkg/models/Linux64_GCC-9.3/FVP_Base_RevC-2xAEMvA \
    ...
    -C bp.pl011_uart0.out_file=out/reference/kokoro_log/hypervisor/arch_mm.block_addr_and_attrs_preserved_level2.uart0.log \
    -C bp.pl011_uart1.out_file=out/reference/kokoro_log/hypervisor/arch_mm.block_addr_and_attrs_preserved_level2.uart1.log \
    --data cluster0.cpu0=/home/workspace2/base/hypervisor/hafnium/prebuilts/linux-aarch64/trusted-firmware-a-trusty/fvp/bl31.bin@0x04020000 \
    --data cluster0.cpu0=out/reference/kokoro_log/hypervisor/arch_mm.block_addr_and_attrs_preserved_level2.dtb@0x82000000 \
